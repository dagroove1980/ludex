...
- Return ONLY valid JSON, no markdown formatting or code blocks`;
  ...
  try {
    ...
    const completion = await openai.chat.completions.create({
      model: 'gpt-4o-mini', // Fast and cost-effective, can use 'gpt-4o' for better quality
      messages: [
        {
          role: 'system',
          content: 'You are an expert at analyzing board game rulebooks. Extract and organize information into structured JSON format.'
        },
        {
          role: 'user',
          content: prompt
